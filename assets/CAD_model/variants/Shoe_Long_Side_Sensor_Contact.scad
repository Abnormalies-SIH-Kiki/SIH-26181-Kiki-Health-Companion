...
part = "shoe"; // Export shoe first; export keeper separately for the matching sensor preload.
...
// Contact revision: the 1.55mm-tall MAX30102 package projects nominally
// 0.91mm past the skin face (1.55 - 0.64). The 0.64mm ledge is four
// 0.16mm layers. Use only with the matching keeper exported from this file.
sensor_seat_z = 0.64;
sensor_pcb_h = 1.6;            // provisional PCB thickness, separate from total 5mm envelope
sensor_keeper_gap = 0.35;      // retains tolerance for a PCB up to about 1.9mm thick
...
assert(sensor_seat_z >= 0.64, "Keep at least four 0.16mm layers beneath the PCB ledge");
