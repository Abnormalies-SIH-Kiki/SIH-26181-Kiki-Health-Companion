...
export DISPLAY=:0
export XAUTHORITY=/home/kiki/.Xauthority
...
(
    source /home/kiki/Kiki/hailo-apps/venv_hailo_apps/bin/activate
    cd /home/kiki/Kiki/navigation
