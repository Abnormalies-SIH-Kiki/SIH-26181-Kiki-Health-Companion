      ...
      <main className="flex-1 px-5 pt-20 pb-28 space-y-7 max-w-5xl mx-auto w-full">
        ...
        <div className="bg-neutral-900/80 border border-white/10 rounded-2xl p-5 shadow-xl backdrop-blur-md mt-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-[11px] text-neutral-400">Waiting for sensor data...</span>
          </div>

          <div className="flex items-center justify-between py-2 border-b border-white/[0.08] pb-5">
            <div className="flex items-baseline gap-2">
              <span className="text-5xl font-bold tracking-tight text-white">--°C</span>
              <span className="text-sm text-neutral-400 font-medium">Feels like --°C</span>
            </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1.5 flex-1">
              <div className="flex items-center justify-between flex-wrap gap-1">
                <span className="text-[11px] font-bold tracking-wider text-red-400 uppercase">IMD SEVERE WEATHER ADVISORY • WAITING</span>
                <span className="text-[10px] text-neutral-400 font-medium bg-white/[0.06] px-2 py-0.5 rounded-full">Waiting for API</span>
              </div>
              <p className="text-xs text-neutral-300 leading-relaxed">
                Advisory information will populate here when severe weather is detected.
              </p>
              <div className="mt-2 pt-2 border-t border-red-500/20 flex items-center gap-2 text-[11px] text-red-300/90 font-medium">
                ...
                <span>Safe outdoor times will be calculated based on live conditions.</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-neutral-900/80 border border-white/10 rounded-2xl p-5 backdrop-blur-md shadow-xl space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="bg-neutral-500/10 border border-neutral-500/30 text-neutral-400 text-xs font-bold px-3 py-1 rounded-xl uppercase tracking-wider">
              AQI -- • WAITING
            </span>
          </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="bg-neutral-800/50 border border-white/[0.05] p-2.5 rounded-xl text-center">
              ...
              <div className="text-sm font-bold text-neutral-300 mt-0.5">-- <span className="text-[10px] font-normal text-neutral-500">µg/m³</span></div>
            </div>
            <div className="bg-neutral-800/50 border border-white/[0.05] p-2.5 rounded-xl text-center">
            ...
            <div className="bg-neutral-800/50 border border-white/[0.05] p-2.5 rounded-xl text-center">
              ...
              <div className="text-sm font-bold text-neutral-300 mt-0.5">-- <span className="text-[10px] font-normal text-neutral-500">ppb</span></div>
            </div>
          </div>
          ...
          <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-3 flex items-start gap-2.5 mt-4">
            ...
            <div className="text-xs text-neutral-300 leading-relaxed">
              <span className="text-amber-300 font-semibold">Personalized Profile:</span> Waiting for health data sync to generate respiratory condition warnings.
            </div>
          </div>
        </div>
        ...
        <div className="bg-neutral-900/80 border border-white/10 rounded-2xl p-5 backdrop-blur-md shadow-xl space-y-4">
          ...
          <div className="grid grid-cols-6 gap-1 text-center pt-1 border-t border-white/[0.06]">
            <div>
              ...
              <div className="text-[10px] text-neutral-500 font-semibold">--°C</div>
              <div className="text-[9px] text-neutral-600">-- AQI</div>
            </div>
            <div>
              <div className="text-[11px] font-medium text-white">2 PM</div>
              <div className="text-[10px] text-neutral-500 font-semibold">--°C</div>
              <div className="text-[9px] text-neutral-600 font-medium">-- AQI</div>
            </div>
            <div>
              <div className="text-[11px] font-bold text-white">3 PM</div>
              <div className="text-[10px] text-neutral-500 font-bold">--°C</div>
              <div className="text-[9px] text-neutral-600 font-bold">-- AQI</div>
            </div>
            <div>
        ...
        <div className="bg-neutral-900/80 border border-white/10 rounded-2xl p-5 backdrop-blur-md shadow-xl space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="bg-neutral-500/10 border border-neutral-500/30 text-neutral-400 font-bold text-xs px-2.5 py-1 rounded-xl uppercase tracking-wider">
              -- / 100 WAITING
            </span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-5 pt-1">
            <div className="relative w-28 h-28 flex-shrink-0 flex items-center justify-center">
              <svg className="w-full h-full -rotate-90" viewBox="0 0 100 100">
                ...
                <circle cx="50" cy="50" r="40" fill="none" stroke="#ef4444" strokeWidth="9" strokeDasharray="251.2" strokeDashoffset="251.2" strokeLinecap="round"></circle>
              </svg>
            ...
            <div className="flex-1 w-full space-y-2.5 text-xs">
              <div className="flex justify-between items-center pb-1.5 border-b border-white/[0.06]">
                ...
                <span className="text-neutral-500 font-semibold">--°C</span>
              </div>
              <div className="flex justify-between items-center pb-1.5 border-b border-white/[0.06]">
              ...
              <div className="flex justify-between items-center pb-1.5 border-b border-white/[0.06]">
                ...
                <span className="text-neutral-500 font-semibold">UV --</span>
              </div>
