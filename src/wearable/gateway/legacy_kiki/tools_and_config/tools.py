...
async def execute_python_code(code: str) -> str:
    ...
    try:
        ...
        result = await asyncio.get_running_loop().run_in_executor(
            None,
            lambda: subprocess.run(
                ["/home/vaibhav/KikiESP32/.venv/bin/python", "-c", code],
                capture_output=True,
                text=True,
                timeout=30,
                cwd="/home/vaibhav/KikiESP32/gateway/legacy_kiki"
            )
        )
        output = ""
        if result.stdout:
    ...
    *_WHATSAPP_TOOL_SCHEMAS,
    {
        ...
        "function": {
            ...
            "description": "Execute a shell command. Useful for checking system status like temperature, disk space, etc.Install all python packagaes in  /home/vaibhav/KikiESP32/.venv/bin/python venv.",
            "parameters": {
                "type": "object",
                "properties": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Execute Python code in a subprocess and return the output. Useful for calculations, data processing, file operations, or any task that benefits from code execution.All python code in run in the /home/vaibhav/KikiESP32/.venv/bin/python venv.",
            "parameters": {
                "type": "object",
                "properties": {
