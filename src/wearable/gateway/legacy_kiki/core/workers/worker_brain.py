...
from core.agent_loop import (  # noqa: F401
    run_agent_loop, MAX_LLM_TURNS, MAX_PROMPT_CHARS, MAX_TOOL_RESULT_CHARS,
    _extract_json_object, _truncate_middle, _compact_conversation)
...
async def execute_worker(worker: Worker) -> tuple[bool, str, str | None]:
    ...
    """
    from tools_and_config.tools import TOOLS, get_detailed_tool_descriptions
